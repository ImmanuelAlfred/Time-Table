...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('time_table_create')): ?>
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="<?php echo e(route('admin.time-tables.create')); ?>">
                        ...
                        <tr data-entry-id="<?php echo e($timeTable->id); ?>">
                            ...
                            <td>
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('time_table_edit')): ?>
                                    <a class="btn btn-xs btn-info" href="<?php echo e(route('admin.time-tables.edit', $timeTable->id)); ?>">
                                ...
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('time_table_delete')): ?>
                                    <form action="<?php echo e(route('admin.time-tables.destroy', $timeTable->id)); ?>" method="POST" onsubmit="return confirm('<?php echo e(trans('global.areYouSure')); ?>');" style="display: inline-block;">
...
<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('time_table_delete')): ?>
  ...
  let deleteButton = {
    ...
    url: "<?php echo e(route('admin.time-tables.massDestroy')); ?>",
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\aimmanuel\Pictures\Timetable-master (1)\Timetable-master\resources\views/admin/timeTables/index.blade.php ENDPATH**/ ?>